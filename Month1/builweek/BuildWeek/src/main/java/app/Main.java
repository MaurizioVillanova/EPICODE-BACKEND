...
public class Main {
	...
	public static void main(String[] args) {
		...
		//insertRivenditore(lineaRoma.MUNICIPIO);enum lineroma e creati tramite save dao
		//insertDistributore(lineaRoma.MUNICIPIO);
		
		/// insert user e
		/// tessera///////////////////////////////////////////////////////////////////
		/// insertUser("mr", "dao"); salvva tramite dao
		// getUserById(4); 

		// insertTessera(4); id user in ingresso e va a recuperare user entitymanagerfinfd e instanzia nuovo oggetto tessera
		// insertTessera(4);
